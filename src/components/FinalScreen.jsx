...
export default function FinalScreen() {
  ...
  return (
    ...
    >
        ...
        <AnimatePresence mode="wait">
          {!cardOpen ? (
            ...
            >
              ...
              <div
                className="cursor-pointer transform transition-all duration-300 hover:scale-105 bg-gradient-to-r from-purple-950/15 via-pink-950/20 to-fuchsia-950/15 backdrop-blur-md border border-pink-500/30 rounded-3xl p-8 w-full mx-auto max-w-84"
            ...
            >
              <motion.div className="bg-gradient-to-r from-purple-950/15 via-pink-950/20 to-fuchsia-950/15 backdrop-blur-md border border-pink-500/30 shadow-2xl rounded-3xl p-8">
                <div
                  ref={messageRef}
      ...
      {showOverlay && (
        <motion.div
          className="fixed inset-0 bg-gradient-to-br from-rose-950/80 via-black/95 to-fuchsia-950/80 backdrop-blur-3xl flex items-center justify-center z-50"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          ...
          >
            ...
            <div className="mb-8 relative">
              ...
              >
                ...
                >
                  <Heart className="w-32 h-32 text-pink-500 fill-current drop-shadow-[0_0_15px_rgba(236,72,153,0.7)]" />
                </motion.div>
              </motion.div>
            </div>
